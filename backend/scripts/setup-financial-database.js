...
async function setupFinancialDatabase() {
    try {
        console.log('💰 Configurando base de datos financiera para SQLFinance...');
        ...
        console.log('📝 Insertando datos de plataformas...');
        await db.query(`
        ...
        console.log('✅ Datos de plataformas insertados exitosamente');
        ...
        console.log('🎉 Base de datos financiera configurada exitosamente!');

    } catch (error) {
        console.error('❌ Error configurando la base de datos financiera:', error);
        process.exit(1);
    } finally {
        await db.end();
    }
